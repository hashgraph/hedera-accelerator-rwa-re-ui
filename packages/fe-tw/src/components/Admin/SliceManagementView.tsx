         ...
         <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-purple-50 p-6 rounded-lg">
               ...
               <p className="text-sm sm:text-base text-gray-700">
                  Manage slices by creating and defining allocations. Slices help automate portfolio
                  management by maintaining predefined allocations across assets.
               </p>
               <p className="mt-4 text-sm sm:text-base text-gray-700">
                  To create a slice, provide a name, a description, and define its allocations. This
