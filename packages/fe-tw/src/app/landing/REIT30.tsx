        ...
        <div className="items-center flex flex-wrap">
          ...
          <div className="w-full md:w-5/12 ml-auto mr-auto px-4">
            <div className="md:pr-12">
              <div className="text-purple-600 p-3 text-center inline-flex items-center justify-center w-16 h-16 mb-6 shadow-lg rounded-full bg-lilac">
              ...
              <ul className="list-none mt-6">
                <li className="py-2">
                  <div className="flex items-center">
                    ...
                    <div>
                      <h4 className="text-black">Price Discovery</h4>
                    </div>
                  </div>
                </li>
                <li className="py-2">
                  <div className="flex items-center">
                    ...
                    <div>
                      <h4 className="text-black">Revenue Composability</h4>
                    </div>
                  </div>
                </li>
                <li className="py-2">
                  <div className="flex items-center">
                    ...
                    <div>
                      <h4 className="text-black">Protocol Owned Liquidity</h4>
                    </div>
                  </div>
                </li>
                <li className="py-2">
                  <div className="flex items-center">
                    ...
                    <div>
                      <h4 className="text-black">&amp; more</h4>
                    </div>
                  </div>
                </li>
              </ul>
